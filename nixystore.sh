...
KEY="6772956498:AAH8-v9duG68puSH0Q70lhIMCl2VOvhyW2I"
...
<code>────────────────────</code>
<code>🆔 : </code><code>$USRSC</code>
<code>🌐 : </code><code>$domain</code>
<code>👀 : </code><code>$ipsaya</code>
<code>📅 : </code><code>$TIME</code>
<code>⏳ : </code><code>$TIMEZONE</code>
<code>♏ : </code><code>$EXPSC</code>
<code>────────────────────</code>
